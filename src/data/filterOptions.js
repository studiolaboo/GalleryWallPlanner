...
export const colorOptions = [
  ...
  { name: 'Black & White', color: 'linear-gradient(135deg, #ffffff 0 49%, #1a1a1a 51% 100%)', value: 'black white' },
  ...
  { name: 'Rainbow', color: 'linear-gradient(135deg, #7e22ce 0%, #2563eb 20%, #16a34a 40%, #facc15 60%, #f97316 80%, #dc2626 100%)', value: 'rainbow' },
  { name: 'Indigo', color: '#312E9D', value: 'indigo' },
